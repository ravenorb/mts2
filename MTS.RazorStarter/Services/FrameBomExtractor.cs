...
public class FrameBomExtractor
{
    ...
    public FrameBomExtractor(MtsDbContext db)
    {
        _db = db;
    }

    public async Task MergeAsync(int parentRevisionId, IReadOnlyList<ExtractedBomRow> extractedRows, bool mergeDuplicateItemNos = true, CancellationToken ct = default)
    {
        var normalizedRows = NormalizeRows(extractedRows, mergeDuplicateItemNos);
        ...
        foreach (var row in normalizedRows)
        {
            ...
            if (existing != null)
            {
                ...
                existing.SourceType = BomSourceType.AutoGenerated;
                continue;
            }
            ...
            var newRow = new ItemBom
            {
                ...
                Notes = row.Notes,
                SourceType = BomSourceType.AutoGenerated
            };
    ...
    private static List<ExtractedBomRow> NormalizeRows(IReadOnlyList<ExtractedBomRow> rows, bool mergeDuplicateItemNos)
    {
        var validRows = rows
